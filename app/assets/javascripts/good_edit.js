$( function() {
  ...
  $(document).on("change", 'input[type= "file"].upload-image', function() {
    ...
    var img = $(`<div class= "img_view  id=${image.id} "><div class="img_area"><img class="image" width ="70" height="114" ></div></div>`);
  ...
  $(document).on('click', '.btn_delete', function() {
    ...
    destroy_images_ids.push(destroy_image_id);
    console.log(destroy_image_id);
    console.log(destroy_images_id);
    // 対象の画像をビュー上で削除
    target_image.remove();
